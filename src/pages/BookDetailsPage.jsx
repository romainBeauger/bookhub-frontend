...
export default function BookDetailsPage() {
    ...
    useEffect(() => {
        ...
        async function loadBook() {
            try {
                ...
                if (!ignore) {
                    setError(err.message || "Impossible de récupérer le livre.");
                }
            } finally {
                if (!ignore) {
                    setLoading(false);
    ...
    return (
        <main className="min-h-screen bg-[#f2f2f2] p-3 md:p-6">
            <section className="mx-auto max-w-[1180px] overflow-hidden rounded-[32px] border border-slate-300 bg-white shadow-[0_30px_80px_rgba(15,23,42,0.12)]">
                <header className="border-b-2 border-violet-500 px-6 py-5">
                    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                            <p className="text-sm text-slate-500">Catalogue / Détails</p>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid gap-4 sm:grid-cols-2">
                                    ...
                                    <div className="rounded-[22px] border border-slate-300 bg-white p-5">
                                        ...
                                        <p className="mt-2 text-lg font-medium text-slate-950">
                                            {book?.publishedAt || "Non renseignée"}
                                        </p>
                                    </div>
                                    <div className="rounded-[22px] border border-slate-300 bg-white p-5">
